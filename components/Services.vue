...
const serviceData = ref([
  {
    id: 1,
    title: "Backend",
    description: [".NET", "SQL", "ENTITY FRAMEWORK", "RESTfulAPI", "C#"],
  },
  {
    id: 2,
    title: "Development",
...
<template>
  <section id="services" class="services section position-relative">
    ...
    <!-- Section Title -->
    <ClientOnly>
      <SectionOverlayText text="Conocimientos" />
      <SectionTitle subtitle="Que puedo aportar en tu proyecto" title="Conocimientos" />
    </ClientOnly>
