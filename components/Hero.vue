  ...
  <section id="top" class="hero" :class="classes">
    <div class="row gx-4 justify-content-center align-items-center">
      ...
      <div class="col-12 col-md-6 col-xl-6 hero-content">
        <div>
          <h4 class="text-uppercase freelancer">Jose Maria Hermosillo</h4>
          <TypeWriter />
          <p class="description">Radicando en CDMX.</p>
        </div>

        <div class="d-flex gap-4">
          <a href="#projects" class="btn work-btn text-capitalize btn-secondary"> Experiencia </a>
          <a href="#contact" class="btn contact-btn text-capitalize btn-outline-secondary"> Contacto </a>
        </div>
      </div>
