...
const navItems = reactive([
  { index: "01", text: "Bienvenido", href: "#top", active: true },
  { index: "02", text: "Sobre mi", href: "#about_me", active: false },
  { index: "03", text: "Conocimientos", href: "#services", active: false },
  { index: "04", text: "Fortalezas", href: "#attainments", active: false },
  { index: "05", text: "Pasatiempos", href: "#fun_facts", active: false },
  { index: "06", text: "experiencia", href: "#experience", active: false },
  { index: "07", text: "proyectos", href: "#projects", active: false },
  { index: "08", text: "Metodologia", href: "#how_i_work", active: false },
  //{ index: "09", text: "blogs", href: "#blogs", active: false },
  //{ index: "10", text: "testimonials", href: "#testimonials", active: false },
  { index: "09", text: "contacto", href: "#contact", active: false },
]);
</script>
...
<template>
  <nav ref="navRef" :class="`navigation ${navOpen ? 'opened' : ''}`" id="navigation">
    ...
    <div class="contact">
      <nuxt-link href="mailto:emily@devis.com">chemamalone96@gmail.com</nuxt-link>
      <nuxt-link href="tel:+420652887351">3313467811</nuxt-link>
    </div>
  </nav>
